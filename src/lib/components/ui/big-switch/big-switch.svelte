...
>
	<SwitchPrimitive.Thumb
		class={cn(
			'bg-background pointer-events-none absolute block h-full w-1/2 rounded-full ring-0 transition-transform data-[state=checked]:translate-x-[100%] data-[state=unchecked]:translate-x-0'
		)}
	/>
