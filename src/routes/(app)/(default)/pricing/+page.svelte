...
>
	...
	>
		<div class="flex gap-2">
			<Button variant="outline" size="lg" href={localizeHref('/contact')}
				>{m.acidic_extra_vulture_enchant()}</Button
			>
			<Button variant="ghost" size="lg" href={githubUrl} target="_blank">
